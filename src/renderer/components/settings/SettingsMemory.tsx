    ...
    <div className="space-y-6">
      ...
      <SettingsContentSection
        ...
        description={t(
          ...
          'Inherits the currently active API config by default. Use this to tune navigation depth, embedding, and storage directory.'
        )}
      >
              ...
              <div className="rounded-xl border border-border-muted bg-background/80 p-4">
                ...
                {inspectedSession ? (
                  ...
                  <p className="mt-3 text-sm text-text-muted">
                    {t('memory.inspectSessionHint', 'Select a session or chunk from the search results above to inspect')}
                  </p>
                )}
              </div>
            </div>
      ...
      <SettingsContentSection
        ...
        description={t(
          ...
          'Directly inspect the persisted core / unified experience / session_state / eval artifacts.'
        )}
      >
