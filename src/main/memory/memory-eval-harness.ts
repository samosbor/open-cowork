...
const DEFAULT_EVAL_CASES: MemoryEvalCase[] = [
  {
    ...
    messages: [
      { role: 'user', text: 'Please use Chinese by default in future replies.', timestamp: 1 },
      { role: 'assistant', text: 'Okay, I will use Chinese by default.', timestamp: 2 },
      {
        role: 'user',
        text: 'Implement gateway token rotation in workspace A and record remote gateway synchronization constraints.',
        timestamp: 3,
      },
      {
        role: 'assistant',
        text: 'Gateway token rotation is complete, and remote gateway must be updated in sync.',
        timestamp: 4,
      },
    ],
    queries: [
      {
        id: 'query-a1',
        prompt: 'Continue gateway token rotation and remind me of the key constraints from last time.',
        workspace: '/eval/workspace-a',
  ...
  },
  {
    ...
    title: 'Design decisions from another workspace',
    ...
    messages: [
      ...
      {
        role: 'assistant',
        text: 'Recorded: refunded and cancelled represent different financial semantics and must remain separate states.',
        timestamp: 11,
      },
    ],
    queries: [
